...
var getTokens = function getTokens(customFoundation) {
  ...
  return {
    ...
    marginButtonGroup: "0 ".concat(theme.base.spaceXs, " 0 0"),
    ...
    // category:Box shadow
    // description:
    boxShadowButtonFocus: "0 0 4px 1px ".concat(theme.base.boxShadowColorStatic),
    boxShadowActionable: "".concat(theme.base.boxShadowActionable, " ").concat(theme.base.boxShadowColorActionable),
    boxShadowElevatedLevel1: "".concat(theme.base.boxShadowElevated, " ").concat(theme.base.boxShadowColorElevated),
    boxShadowModal: "".concat(theme.base.boxShadowModal, " ").concat(theme.base.boxShadowColorModal),
